<header id="topnav">
    <!-- Topbar Start -->
    <div class="navbar-custom" style="background-color: #0b0b0b">
        <div class="container-fluid">
                            ...
                            <div class="inbox-widget">
                                <a href="#">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img"><img src="/assets\images\users\main.jpg"
                ...
                <li class="dropdown notification-list">
                    <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown"
                       href="#" role="button" aria-haspopup="false" aria-expanded="false">
                        <img src="/assets\images\users\main.jpg" alt="user-image" class="rounded-circle">
                    </a>
            ...
            <div class="logo-box">
                <a href="/products" class="logo text-center">
                                    <span class="logo-lg">
                                        <img src="/assets\images\images.jpg" alt="" height="60" width="100">
                        ...
                        <div class="app-search-box">
                            <div class="input-group">
                                <input type="text" name="searchproduct" class="form-control"
                                       placeholder="Search..." value="${requestScope.searchproduct}">
            ...
            <div id="navigation">
                ...
                <ul class="navigation-menu">
                    ...
                    <li class="has-submenu">
                        <a href="/products"> <i class="mdi mdi-home-map-marker"></i>Home</a>
                    </li>

                    <li class="has-submenu">
                        <a href="/users">
                            <i class="mdi mdi-layers"></i>Manager User
                        </a>
                    </li>
